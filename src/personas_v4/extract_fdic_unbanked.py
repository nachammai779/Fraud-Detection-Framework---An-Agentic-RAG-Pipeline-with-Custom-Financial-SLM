...
Source:  datasets_v4/sources/pdfs/hh2023/
  - hh2023_analys.csv           (309 MB analytic microdata; local-only)
  - metadata/metadata.csv       (variable value labels)

Output:  datasets_v4/sources/extracts/fdic_2023_hh_microdata.json
...
HH = ROOT / "datasets_v4" / "sources" / "pdfs" / "hh2023"
CSV = HH / "hh2023_analys.csv"
META = HH / "metadata" / "metadata.csv"
OUT = ROOT / "datasets_v4" / "sources" / "extracts" / "fdic_2023_hh_microdata.json"
